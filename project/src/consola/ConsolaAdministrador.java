	...
	private static void agregarAtraccion(Scanner scanner) {
        ...
        private static void agregarEspectaculo(Scanner scanner) {
            ...
            try {
                ...
                System.out.println("⚠️ Error: formato de fecha inválido. Usa dd-MM-yyyy (por ejemplo, 22-05-2025).");
            }
        }
        ...
        private static void agregarEmpleado(Scanner scanner) {
            ...
            System.out.println("4. Sin labor por ahora");
            System.out.print("Opción: ");
            ...
            switch (tipo) {
                ...
                case 4 -> {
                    ...
                    empleado = new EmpleadoServiciosgenerales(usuario, password, edad, altura, cafeteria, "");
                }
                default -> System.out.println("Opción inválida.");
            }
            
            Cafeteria cafe= new Cafeteria("Cafeteria central");
            if (empleado != null) {
            	try {
            		parque.agregarUsuario(empleado);
            		administrador.AsignarLabor(empleado, labor, cafe);
                    System.out.println("Empleado agregado.");
            	} catch (Exception e) {
            		System.out.println("\n"+e.getMessage()+"\n");
            		System.out.println("\nEl empleado no fue añadido\n");
            	}
            }
        }
