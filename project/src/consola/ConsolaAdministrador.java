...
public class ConsolaAdministrador extends ConsolaUsuario {
    ...
    public ConsolaAdministrador(Parque parque, Administrador administrador) {
        super(parque);
        ConsolaAdministrador.parque = parque;
    ...
    public static void main(String[] args) {
        ...
        if (parque == null) {
            parque = new Parque(null, null, 0);
            System.out.println("⚠️ Parque nuevo creado (no se encontró uno previo).");
        }

        // Inicializar administrador
        administrador = new Administrador("admin", "admin123", 35, 1.75f);
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 7 -> {
                        ...
                        System.out.println("✔️ Parque guardado exitosamente.");
                        continuar = false;
                    }
